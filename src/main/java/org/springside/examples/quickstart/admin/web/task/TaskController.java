 ...
 *******************************************************************************/
package org.springside.examples.quickstart.admin.web.task;
...
import org.springside.examples.quickstart.admin.service.task.TaskService;
...
public class TaskController {
	...
	public String list(@RequestParam(value = "page", defaultValue = "1") int pageNumber,
		...
		return "admin/views/task/taskList";
	}
	...
	public String createForm(Model model) {
		...
		return "admin/views/task/taskForm";
	}
